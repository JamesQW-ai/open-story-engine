...
targetCjk必须位于80至1500之间。简单确认、等待或一次告知可以规划较短正文，但只能表达当前授权行动的过程、人物反应和直接后果；复杂交锋可延长，超过1200字必须有新的因果、反应或线索，超过1500字禁止。不要根据step数量、是否转场或用户输入长短机械填充；不要为了预算发明冲突。beats覆盖已授权steps，每个过程有不同作用，没有必要的过程不添加。完成当前事情就停，不留待正文不足后扩写。
